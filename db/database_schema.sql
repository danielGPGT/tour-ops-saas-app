...
CREATE TABLE public.allocation_buckets (
  ...
  CONSTRAINT allocation_buckets_inventory_pool_id_fkey FOREIGN KEY (inventory_pool_id) REFERENCES public.inventory_pools(id),
  CONSTRAINT allocation_buckets_slot_id_fkey FOREIGN KEY (slot_id) REFERENCES public.time_slots(id)
);
